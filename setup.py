#!/usr/bin/env python
# Licensed under a 3-clause MIT style license - see LICENSE.rst
...
#
setup_keywords['name'] = 'instrumentsim'
setup_keywords['description'] = 'Simulation of astronomical instruments'
setup_keywords['author'] = 'Sunil Simha'
setup_keywords['author_email'] = 'shassans@ucsc.edu'
setup_keywords['license'] = 'MIT'
setup_keywords['url'] = 'https://github.com/SunilSimha/instrumentation'
#
